...
from . import msg
from .msg import v9
from .msg.v9 import publish_pb2
from .msg.v9 import gz_string_pb2
from .msg.v9 import gz_string_v_pb2
from .msg.v9 import subscribe_pb2
from .msg.v9 import packet_pb2
from .msg.v9 import publishers_pb2
...
class Subscriber(object):
    ...
    def _connect2(self, future, connection, pub):
        ...
        # Packet structure.
        to_send = msg.v9.subscribe_pb2.Subscribe()
...
class _Connection(object):
    ...
    def write_packet(self, name, message):
        packet = msg.v9.packet_pb2.Packet()
        cur_time = time.time()
...
class Manager(object):
    ...
    def advertise(self, topic_name, msg_type):
        ...
        to_send = msg.v9.publish_pb2.Publish()
    ...
    def handle_initdata(self, future, result):
        try:
            ...
            self._handle_version_init(
                msg.v9.gz_string_pb2.GzString.FromString(
    ...
    def _handle_server_data(self, future, connection):
        ...
        if message.type == 'sub':
            self._handle_server_sub(
                connection,
                msg.v9.subscribe_pb2.Subscribe.FromString(
    ...
    _MSG_HANDLERS = {
        'publisher_add': (_handle_publisher_add, msg.v9.publish_pb2.Publish),
        'publisher_del': (_handle_publisher_del, msg.v9.publish_pb2.Publish),
        'namespace_add': (_handle_namespace_add, msg.v9.gz_string_pb2.GzString),
        'publisher_subscribe': (_handle_publisher_subscribe,
                                msg.v9.publish_pb2.Publish),
        'publisher_advertise': (_handle_publisher_subscribe,
                                msg.v9.publish_pb2.Publish),
        'unsubscribe': (_handle_unsubscribe, msg.v9.subscribe_pb2.Subscribe),
        'unadvertise': (_handle_unadvertise, msg.v9.publish_pb2.Publish),
        }
