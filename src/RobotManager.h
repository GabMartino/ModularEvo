...
namespace gazebo{
  ...
  protected:
        ...
        /// \brief position of the robot at the start of the test
        ...
        /// \brief time interval of the test in seconds
        ...
        /// \brief timestamp of the last test, used with testingTime_ to count the interval of Test
        ...
        void reportFitness(double fitness);
